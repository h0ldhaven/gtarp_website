...
class TwitchTV {
  ...
  var $client_id = "n47th28ii8g3ccf4wesagcht5ufvob"; //change this value, should be your TwitchTV Application Client ID
  var $client_secret = "lfnlkq0pmovcb379d0gtx8ukei4wc8"; //change this value, should be your TwitchTV Application Client Secret 
  var $redirect_url = "http://hold/streams.php"; //change this value, should be your TwitchTV Application Rerdirect URL
